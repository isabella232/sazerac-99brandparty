...
export async function decorateIcons(element) {
  ...
  icons.forEach((span) => {
    ...
    parent.parentElement.title = iconName;
 ...
 */
export function createOptimizedPicture(src, alt = '', eager = false, breakpoints = [{ media: '(min-width: 750px)', width: '2000' }, { media: '(min-width: 450px)', width: '750' }, { width: '450' }]) {
