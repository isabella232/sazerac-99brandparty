...
export default async function decorate(block) {
  if (block.querySelector('p') == null) {
    ...
    partypacks.querySelector('a').prepend(createOptimizedPicture('/media/media_14dee3756c049dd3ca4ccb186e085f0f17ac2a7e7.png', 'image of 99 party packs', false, [{ width: '750' }]));
    ...
    spirits.querySelector('a').prepend(createOptimizedPicture('/media/media_1f64794813e03174a26df5b1136ddc19f2ffb717f.png', 'image of 99 spirits collection', false, [{ width: '750' }]));
